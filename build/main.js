...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    CanvasRenderingContext2D: {
      "^": "Interceptor;fillStyle},font}",
      arc$6: function(receiver, x, y, radius, startAngle, endAngle, anticlockwise) {
        receiver.arc(x, y, radius, startAngle, endAngle, false);
      },
    ...
    "^": "",
    AIPlayer: {
      "^": "Player;isPlayer1,top,ball,canvasHeight"
    }
  }], ["", "../src/ball.dart",, X, {
    "^": "",
    Angle: {
      "^": "Object;index,_ball$_name",
      toString$0: function(_) {
        return this._ball$_name;
      }
    },
    Ball: {
      "^": "Object;_canvasHeight,_x,_y,_currentAngle,_speed,_verticalFactor,_horizontalFactor,random",
      _randomizeAngle$0: function() {
        var t1, t2;
        t1 = this.random.nextInt$1(3);
        if (t1 < 0 || t1 >= 3)
          return H.ioore(C.List_oJ8, t1);
        t1 = C.List_oJ8[t1];
        this._currentAngle = t1;
        if (t1 === C.Angle_2)
          this._verticalFactor = 0;
        else {
          t1 = [-1, 1];
          t2 = this.random.nextInt$1(2);
          if (t2 < 0 || t2 >= 2)
            return H.ioore(t1, t2);
          this._verticalFactor = t1[t2];
        }
        t1 = [-1, 1];
        t2 = this.random.nextInt$1(2);
        if (t2 < 0 || t2 >= 2)
          return H.ioore(t1, t2);
        this._horizontalFactor = t1[t2];
      },
      _rotateAngle$1: function(rotation) {
        var t1;
        if (rotation === 0)
          return;
        else if (rotation === -1) {
          t1 = this._verticalFactor;
          if (t1 === 0) {
            t1 = this._horizontalFactor;
            if (typeof t1 !== "number")
              return t1.$negate();
            this._verticalFactor = -t1;
            this._currentAngle = C.Angle_1;
          } else if (t1 === -1)
            if (this._horizontalFactor === -1) {
              if (!(this._currentAngle === C.Angle_0)) {
                this._currentAngle = C.Angle_2;
                this._verticalFactor = 0;
              }
            } else
              this._currentAngle = C.Angle_0;
          else if (this._horizontalFactor === -1)
            this._currentAngle = C.Angle_0;
          else if (this._currentAngle === C.Angle_0)
            this._currentAngle = C.Angle_1;
          else {
            this._currentAngle = C.Angle_2;
            this._verticalFactor = 0;
          ...
          t1 = this._verticalFactor;
          if (t1 === 0) {
            this._verticalFactor = this._horizontalFactor;
            this._currentAngle = C.Angle_1;
          } else if (t1 === -1)
            if (this._horizontalFactor === -1)
              this._currentAngle = C.Angle_0;
      ...
      move$0: function() {
        var t1, t2, t3, angle;
        t1 = this._currentAngle;
        if (t1 === C.Angle_2) {
          t1 = this._x;
          t2 = this._speed;
          t3 = this._horizontalFactor;
          if (typeof t3 !== "number")
            return H.iae(t3);
          this._x = t1 + t2 * t3;
          return;
        }
        angle = t1 === C.Angle_0 ? 0.7853981633974483 : 0.39269908169872414;
        t1 = this._x;
        t2 = C.JSNumber_methods.round$0(Math.cos(angle) * this._speed);
        t3 = this._horizontalFactor;
        if (typeof t3 !== "number")
          return H.iae(t3);
        this._x = t1 + t2 * t3;
        t3 = this._y;
        t2 = C.JSNumber_methods.round$0(Math.sin(angle) * this._speed);
        t1 = this._verticalFactor;
        if (typeof t1 !== "number")
          return H.iae(t1);
        t1 = t3 + t2 * t1;
        this._y = t1;
        t2 = this._canvasHeight;
        if (typeof t2 !== "number")
          return H.iae(t2);
        if (t1 + 30 > t2) {
          this._y = 2 * t2 - t1 - 60;
      ...
      bounceLeft$2: function(paddleX, rotation) {
        var t1;
        this._x = 2 * paddleX - this._x - 60;
        this._horizontalFactor = -1;
        this._rotateAngle$1(rotation);
        t1 = this._speed;
        if (t1 < 30)
          this._speed = t1 + 1;
      },
      bounceRight$2: function(paddleX, rotation) {
        var t1;
        this._x = 2 * paddleX - this._x + 60;
        this._horizontalFactor = 1;
        this._rotateAngle$1(rotation);
    ...
    Display: {
      "^": "Object;",
      clearDisplay$0: function() {
        var t1, t2, t3;
        t1 = this.canvasContext;
  ...
  }], ["", "../src/enddisplay.dart",, Z, {
    "^": "",
    EndDisplay: {
      "^": "Display;_isDone,_enddisplay$_mouse,_latestScore,_isTwoPlayer,_mustChangeSettings,canvas,canvasContext",
      _getVictoryMessage$0: function() {
        if (this._isTwoPlayer === true) {
          var t1 = this._latestScore;
          return t1.score1 > t1.score2 ? "Player 1 has won!" : "Player 2 has won!";
        } else {
          t1 = this._latestScore;
          return t1.score1 > t1.score2 ? "You won the game!" : "You lost the game\u2026";
        }
      },
      _update$0: function() {
        var t1, mouseCoordinates, mouseX, mouseY;
        t1 = this._enddisplay$_mouse;
        if (t1.hasNewClick$0() !== true)
          return;
        mouseCoordinates = [t1._clickX, t1._clickY];
        ...
        if (mouseX >= 50)
          if (mouseX <= 320) {
            if (typeof mouseY !== "number")
              return mouseY.$ge();
            t1 = mouseY >= 350 && mouseY <= 430;
          } else
            t1 = false;
        else
          t1 = false;
        if (t1) {
          this._mustChangeSettings = false;
          this._isDone = true;
        } else {
          if (mouseX >= 560)
            if (mouseX <= 950) {
            ...
            t1 = false;
          if (t1) {
            this._mustChangeSettings = true;
            this._isDone = true;
          }
        }
      },
      updateAndDraw$0: function() {
        var t1, t2;
        this._update$0();
        this.clearDisplay$0();
        t1 = this.canvasContext;
        J.getInterceptor$x(t1).set$font(t1, "36pt IBM Plex Sans");
        t2 = this._latestScore;
        t1.fillStyle = t2.score1 > t2.score2 ? "red" : "blue";
        C.CanvasRenderingContext2D_methods.fillText$3(t1, this._getVictoryMessage$0(), 300, 150);
        t1.fillStyle = "#00cc03";
        t1.fillRect(50, 350, 270, 80);
        t1.font = "36pt IBM Plex Sans";
        t1.fillStyle = "white";
        C.CanvasRenderingContext2D_methods.fillText$3(t1, "Play Again", 75, 405);
        t1.fillStyle = "#00cc03";
        t1.fillRect(560, 350, 390, 80);
        t1.font = "36pt IBM Plex Sans";
        t1.fillStyle = "white";
        C.CanvasRenderingContext2D_methods.fillText$3(t1, "Change Settings", 585, 405);
      },
      isDone$0: function() {
        return this._isDone;
      },
  ...
  }], ["", "../src/gamedisplay.dart",, M, {
    "^": "",
    GameDisplay: {
      "^": "Display;_gamedisplay$_isDone,_gamedisplay$_keyboard,_currentScore,_scoreElement,_player1,_player2AI,_player2Human,_player2,_ball,_playToScore,canvas,canvasContext",
      _updateDisplayedScore$0: function() {
        this._scoreElement.textContent = "" + this._currentScore.score1 + "-" + this._currentScore.score2;
      },
      updateAndDraw$0: function() {
        var t1, t2, ballY, ballX, player1Coordinates, player2Coordinates, ballCoordinates;
        this._ball.move$0();
        t1 = this._gamedisplay$_keyboard._keys;
        if (t1.containsKey$1(87))
          this._player1.moveUp$0();
        else if (t1.containsKey$1(83))
          this._player1.moveDown$0();
        if (this._player2 === this._player2Human) {
          if (t1.containsKey$1(38))
            this._player2Human.moveUp$0();
          else if (t1.containsKey$1(40))
            this._player2Human.moveDown$0();
        } else {
          t1 = this._player2AI;
          t2 = t1.ball;
          ballY = [t2._x, t2._y][1];
          ...
          if (ballY <= t2 + 50)
            t1.moveUp$0();
          else if (ballY >= t2 + 100)
            t1.moveDown$0();
        }
        this._player1.checkCollisionsWithBall$0();
        this._player2.checkCollisionsWithBall$0();
        t1 = this._ball;
        ballX = [t1._x, t1._y][0];
        if (ballX + 30 < 0) {
          ++this._currentScore.score2;
          this._updateDisplayedScore$0();
          this._ball.reset$0(0);
          if (this._currentScore.score2 === this._playToScore)
            this._gamedisplay$_isDone = true;
        } else {
          t1 = J.get$width$x(this.canvas);
          if (typeof t1 !== "number")
            return H.iae(t1);
          if (ballX - 30 > t1) {
            ++this._currentScore.score1;
            this._updateDisplayedScore$0();
            this._ball.reset$0(0);
            if (this._currentScore.score1 === this._playToScore)
              this._gamedisplay$_isDone = true;
          }
        }
        this.clearDisplay$0();
        player1Coordinates = this._player1.getTopLeftCoordinates$0();
        t1 = this.canvasContext;
        J.getInterceptor$x(t1).set$fillStyle(t1, "red");
        t1.fillRect(player1Coordinates[0], player1Coordinates[1], 25, 150);
        player2Coordinates = this._player2.getTopLeftCoordinates$0();
        t1.fillStyle = "blue";
        t1.fillRect(player2Coordinates[0], player2Coordinates[1], 25, 150);
        t2 = this._ball;
        ballCoordinates = [t2._x, t2._y];
        t1.fillStyle = "white";
        t1.beginPath();
        C.CanvasRenderingContext2D_methods.arc$5(t1, ballCoordinates[0], ballCoordinates[1], 30, 0, 6.283185307179586);
        C.CanvasRenderingContext2D_methods.fill$0(t1);
      },
      isDone$0: function() {
        return this._gamedisplay$_isDone;
      },
      reset$0: function(_) {
        var t1;
        this._gamedisplay$_isDone = false;
        t1 = this._currentScore;
        t1.score1 = 0;
        t1.score2 = 0;
        this._updateDisplayedScore$0();
      },
      GameDisplay$2: function(canvas, keyboard) {
        var t1, t2;
        this._currentScore = new S.Score(0, 0);
        t1 = J.getInterceptor$x(canvas);
        t2 = new X.Ball(t1.get$height(canvas), 500, 250, null, 15, null, null, null);
        t2.random = C.C__JSRandom;
        t2._randomizeAngle$0();
        t2._horizontalFactor = -1;
        this._ball = t2;
        t2 = t1.get$height(canvas);
        this._player1 = new A.HumanPlayer(true, 175, this._ball, t2);
        t2 = t1.get$height(canvas);
        this._player2AI = new Y.AIPlayer(false, 175, this._ball, t2);
        t1 = t1.get$height(canvas);
        this._player2Human = new A.HumanPlayer(false, 175, this._ball, t1);
        this._player2 = this._player2AI;
        this._scoreElement = document.querySelector("#score");
      },
      static: {
        GameDisplay$: function(canvas, keyboard) {
          var t1 = new M.GameDisplay(false, keyboard, null, null, null, null, null, null, null, 7, canvas, J.getContext$1$x(canvas, "2d"));
          t1.GameDisplay$2(canvas, keyboard);
          return t1;
        }
      }
    }
  }], ["", "../src/humanplayer.dart",, A, {
    "^": "",
    HumanPlayer: {
      "^": "Player;isPlayer1,top,ball,canvasHeight"
    }
    ...
    Keyboard: {
      ...
      Keyboard$0: function() {
        ...
        W._EventStreamSubscription$(window, "keydown", new Y.Keyboard_closure(this), false, t1);
        W._EventStreamSubscription$(window, "keyup", new Y.Keyboard_closure0(this), false, t1);
      },
      static: {
        Keyboard$: function() {
          var t1 = new Y.Keyboard(P.HashMap_HashMap(null, null, null, P.int, P.num));
          t1.Keyboard$0();
          return t1;
        }
      }
    ...
    Keyboard_closure: {
      ...
      call$1: function($event) {
        var t1 = this.$this._keys;
        if (!t1.containsKey$1(J.get$keyCode$x($event)))
          t1.$indexSet(0, $event.keyCode, $event.timeStamp);
      }
    },
    Keyboard_closure0: {
      "^": "Closure:5;$this",
    ...
    Mouse: {
      "^": "Object;_clickX,_clickY,_hasNewClick",
      hasNewClick$0: function() {
        var tmp = this._hasNewClick;
        this._hasNewClick = false;
        return tmp;
      },
      Mouse$0: function() {
        W._EventStreamSubscription$(window, "mousedown", new Y.Mouse_closure(this), false, W.MouseEvent);
      },
      static: {
        Mouse$: function() {
          var t1 = new Y.Mouse(null, null, null);
          t1.Mouse$0();
          return t1;
        }
      }
    ...
    Mouse_closure: {
      ...
      call$1: function($event) {
        ...
        t3 = t2.get$offset($event);
        t1._clickX = t3.get$x(t3);
        t2 = t2.get$offset($event);
        t1._clickY = t2.get$y(t2);
        t1._hasNewClick = true;
      }
    }
  }], ["", "../src/main.dart",, F, {
    "^": "",
    main: [function() {
      var t1, t2, t3, t4, t5;
      t1 = new F.Main(null, null, null, null, null, null, null, null, null, null, 0);
      t2 = document.querySelector("#mycanvas");
      t1._canvas = t2;
      t1._canvasContext = J.getContext$1$x(t2, "2d");
      t3 = Y.Keyboard$();
      t1._keyboard = t3;
      t4 = Y.Mouse$();
      t1._mouse = t4;
      t5 = new N.SettingsDisplay(false, t4, null, t2, C.CanvasElement_methods.getContext$1(t2, "2d"));
      t5._currentSettings = new G.Settings(false, 7);
      t1._settingsDisplay = t5;
      t1._gameDisplay = M.GameDisplay$(t2, t3);
      t1._endDisplay = new Z.EndDisplay(false, t4, null, null, false, t2, C.CanvasElement_methods.getContext$1(t2, "2d"));
      t1._currentDisplay = t5;
      C.Window_methods.get$animationFrame(window).then$1(t1.get$update());
    }, "call$0", "main__main$closure", 0, 0, 1],
    Main: {
      "^": "Object;_canvas,_canvasContext,_keyboard,_mouse,_settingsDisplay,_gameDisplay,_endDisplay,_currentDisplay,_main$_latestScore,_main$_currentSettings,_lastUpdateTime",
      _checkAndTransitionDisplay$0: function() {
        var t1, nextDisplay, nextDisplay0, t2;
        if (!this._currentDisplay.isDone$0())
          return;
        t1 = this._currentDisplay;
        nextDisplay = this._settingsDisplay;
        if (t1 === nextDisplay) {
          nextDisplay0 = this._gameDisplay;
          t1 = nextDisplay._currentSettings;
          this._main$_currentSettings = t1;
          nextDisplay0._player2 = t1.isTwoPlayer ? nextDisplay0._player2Human : nextDisplay0._player2AI;
          nextDisplay0._playToScore = t1.playToScore;
          nextDisplay = nextDisplay0;
        } else {
          nextDisplay0 = this._gameDisplay;
          if (t1 === nextDisplay0) {
            nextDisplay = this._endDisplay;
            t1 = nextDisplay0._currentScore;
            this._main$_latestScore = t1;
            t2 = this._main$_currentSettings.isTwoPlayer;
            nextDisplay._latestScore = t1;
            nextDisplay._isTwoPlayer = t2;
          } else
            nextDisplay = this._endDisplay._mustChangeSettings ? nextDisplay : nextDisplay0;
        }
        nextDisplay.reset$0(0);
        this._currentDisplay = nextDisplay;
      },
      update$1: [function(currentTime) {
        var t1;
        if (J.$gt$n(J.$sub$n(currentTime, this._lastUpdateTime), 50)) {
          this._lastUpdateTime = currentTime;
          t1 = this._canvasContext;
          J.set$fillStyle$x(t1, "black");
          t1.fillRect(0, 0, J.get$width$x(this._canvas), J.get$height$x(this._canvas));
          this._currentDisplay.updateAndDraw$0();
          this._checkAndTransitionDisplay$0();
        }
    ...
    Player: {
      "^": "Object;",
      getTopLeftCoordinates$0: function() {
        var x = this.isPlayer1 ? 25 : 950;
        return [x, this.top];
      },
      moveUp$0: function() {
        var t1 = this.top -= 10;
        this.top = Math.max(t1, 0);
      },
      moveDown$0: function() {
        var t1, t2;
        t1 = this.top += 10;
        ...
        if (typeof t2 !== "number")
          return t2.$sub();
        this.top = Math.min(t1, t2 - 150);
      },
      checkCollisionsWithBall$0: function() {
        var t1, ballCoordinates, ballX, ballY, t2, paddleBottom, paddleOneThirdDown, paddleTwoThirdsDown, t3, t4;
        t1 = this.ball;
        ballCoordinates = [t1._x, t1._y];
        ballX = ballCoordinates[0];
        ballY = ballCoordinates[1];
        t2 = this.top;
        paddleBottom = t2 + 150;
        paddleOneThirdDown = t2 + 50;
        paddleTwoThirdsDown = t2 + 100;
        if (ballX > 950 || ballX < 50)
          return;
        t3 = ballX + 30;
        if (t3 < 950 && ballX - 30 > 50)
          return;
        t4 = this.isPlayer1;
        if (t4 && ballX - 30 <= 50) {
          if (ballY > paddleOneThirdDown && ballY < paddleTwoThirdsDown)
            t1.bounceRight$2(50, 0);
          else if (ballY <= paddleOneThirdDown) {
            if (ballY >= t2 || Math.sqrt(Math.pow(ballX - 50, 2) + Math.pow(ballY - this.top, 2)) < 30)
              t1.bounceRight$2(50, -1);
          } else if (ballY <= paddleBottom || Math.sqrt(Math.pow(ballX - 50, 2) + Math.pow(ballY - paddleBottom, 2)) < 30)
            t1.bounceRight$2(50, 1);
        } else if (!t4 && t3 >= 950)
          if (ballY > paddleOneThirdDown && ballY < paddleTwoThirdsDown)
            t1.bounceLeft$2(950, 0);
          else if (ballY <= paddleOneThirdDown) {
            if (ballY >= t2 || Math.sqrt(Math.pow(ballX - 950, 2) + Math.pow(ballY - this.top, 2)) < 30)
              t1.bounceLeft$2(950, 1);
          } else if (ballY <= paddleBottom || Math.sqrt(Math.pow(ballX - 950, 2) + Math.pow(ballY - paddleBottom, 2)) < 30)
            t1.bounceLeft$2(950, -1);
      }
    }
  }], ["", "../src/score.dart",, S, {
    ...
    "^": "",
    Settings: {
      "^": "Object;isTwoPlayer,playToScore"
    }
  }], ["", "../src/settingsdisplay.dart",, N, {
    "^": "",
    SettingsDisplay: {
      "^": "Display;_settingsdisplay$_isDone,_settingsdisplay$_mouse,_currentSettings,canvas,canvasContext",
      _drawButton$3: function(x, y, text) {
        var t1 = this.canvasContext;
        J.getInterceptor$x(t1).set$fillStyle(t1, "#00cc03");
        t1.fillRect(x, y, 70, 70);
        t1.font = "36pt IBM Plex Mono";
        t1.fillStyle = "white";
        C.CanvasRenderingContext2D_methods.fillText$3(t1, text, x + 20, y + 70 - 20);
      },
      _settingsdisplay$_update$0: function() {
        var t1, mouseCoordinates, mouseX, mouseY, t2, t3;
        t1 = this._settingsdisplay$_mouse;
        if (t1.hasNewClick$0() !== true)
          return;
        mouseCoordinates = [t1._clickX, t1._clickY];
        mouseX = mouseCoordinates[0];
        ...
        if (t1)
          if (mouseX <= 670) {
            if (typeof mouseY !== "number")
              return mouseY.$ge();
            t2 = mouseY >= 40 && mouseY <= 110;
          } else
            t2 = false;
        else
          t2 = false;
        if (t2)
          this._currentSettings.isTwoPlayer = false;
        else {
          t2 = mouseX >= 850;
          if (t2)
            if (mouseX <= 920) {
              if (typeof mouseY !== "number")
                return mouseY.$ge();
              t3 = mouseY >= 40 && mouseY <= 110;
            } else
              t3 = false;
          else
            t3 = false;
          if (t3)
            this._currentSettings.isTwoPlayer = true;
          else {
            if (t1)
              if (mouseX <= 670) {
                if (typeof mouseY !== "number")
                  return mouseY.$ge();
                t1 = mouseY >= 200 && mouseY <= 270;
              } else
                t1 = false;
            else
              t1 = false;
            if (t1) {
              t1 = this._currentSettings;
              t1.playToScore = Math.max(1, t1.playToScore - 1);
            } else {
              if (t2)
                if (mouseX <= 920) {
                  if (typeof mouseY !== "number")
              ...
              if (t1) {
                t1 = this._currentSettings;
                t1.playToScore = Math.min(99, t1.playToScore + 1);
              } else {
                if (mouseX >= 400)
                  if (mouseX <= 600) {
                    if (typeof mouseY !== "number")
                      return mouseY.$ge();
                    t1 = mouseY >= 350 && mouseY <= 450;
                  } else
                    t1 = false;
                else
                  t1 = false;
                if (t1)
                  this._settingsdisplay$_isDone = true;
              }
            }
          }
        }
      ...
      updateAndDraw$0: function() {
        this._settingsdisplay$_update$0();
        this.clearDisplay$0();
        var t1 = this.canvasContext;
        J.getInterceptor$x(t1).set$font(t1, "36pt IBM Plex Sans");
        t1.fillStyle = "white";
        C.CanvasRenderingContext2D_methods.fillText$3(t1, "Number of players:", 50, 90);
        C.CanvasRenderingContext2D_methods.fillText$3(t1, "Score needed to win:", 50, 250);
        this._drawButton$3(600, 40, "-");
        this._drawButton$3(850, 40, "+");
        t1.font = "36pt IBM Plex Mono";
        t1.fillStyle = "white";
        C.CanvasRenderingContext2D_methods.fillText$3(t1, "" + (this._currentSettings.isTwoPlayer ? 2 : 1), 750, 90);
        this._drawButton$3(600, 200, "-");
        this._drawButton$3(850, 200, "+");
        t1.font = "36pt IBM Plex Mono";
        t1.fillStyle = "white";
        C.CanvasRenderingContext2D_methods.fillText$3(t1, C.JSString_methods.padLeft$2(H.S(this._currentSettings.playToScore), 2, "0"), 740, 250);
        t1.fillStyle = "#00cc03";
        t1.fillRect(400, 350, 200, 100);
        t1.font = "36pt IBM Plex Mono";
        t1.fillStyle = "white";
        C.CanvasRenderingContext2D_methods.fillText$3(t1, "START", 430, 420);
      },
      isDone$0: function() {
        return this._settingsdisplay$_isDone;
      },
      reset$0: function(_) {
        this._settingsdisplay$_isDone = false;
      }
    }
  }]];
  setupProgram(dart, 0);
  ...
  C.Angle_0 = new X.Angle(0, "Angle.STEEP");
  C.Angle_1 = new X.Angle(1, "Angle.MIDDLE");
  C.Angle_2 = new X.Angle(2, "Angle.STRAIGHT");
...
;
  ...
  C.List_oJ8 = Isolate.makeConstantList([C.Angle_0, C.Angle_1, C.Angle_2]);
  ...
  $ = new Isolate();
  init.metadata = [null];
  init.types = [{func: 1}, {func: 1, v: true}, {func: 1, args: [,]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, ret: P.String, args: [P.int]}, {func: 1, args: [W.KeyboardEvent]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, args: [,,]}, {func: 1, args: [W.MouseEvent]}, {func: 1, v: true, args: [P.num]}];
